...
describe EmailAddressesController do
  ...
  let(:valid_attributes) { { address: "MyString", contact_id: 1, contact_type: 'Company' } }
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      let(:valid_attributes) { {address: 'someone@example.com', contact_id: bob.id, contact_type: 'Person'} }
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the owning contact" do
      email_address = EmailAddress.create! valid_attributes
      delete :destroy, {:id => email_address.to_param}, valid_session
